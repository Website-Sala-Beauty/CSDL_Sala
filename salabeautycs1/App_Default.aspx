...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="navabar">
        <span style="margin-left: 26%; margin-top: 19px;"><span style="font-family: 'Great Vibes'; font-size: 75px;">Sala Client1</span><span style="margin-left: 25px; font-size: 42px;">NAILS & BEAUTY</span></span>
    ...
    <div class="base">
        ...
        <div class="block-dichvu">
            ...
            <div class="title-chinh">
                <div class="ten">DỊCH VỤ TẠI SALA CO SO 1</div>
            </div>
